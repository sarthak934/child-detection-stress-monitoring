...
This project implements an end-to-end computer vision pipeline designed for real-time monitoring and historical analysis of child presence and stress-like postures in video feeds. The system combines object detection, pose estimation, behavior-aware feature extraction, cloud-based data storage, and web-based visualization.
...
- Read-only Flask API for structured data access  
...
- **Standard Operating Procedure (SOP):**  
  See `sop/SOP_Workflow.md` for a complete step-by-step explanation of the detection pipeline, feature extraction, system design, and data flow.
...
9. Dashboard visualizes and filters results  
